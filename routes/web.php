...
Route::prefix("/user")->group(function() {
    ...
    Route::get("/historyQR", [HistoryController::class,"historyQR"])->middleware(["auth","verified"]);
    // Route::get("/history", [HistoryController::class,"historyFilter"])->middleware(["auth","verified"]);
