...
<main>
    ...
    <!-- pricing-area -->
    <section class="pricing-area pricing-bg" data-background="{{ asset('assets/img/bg/pricing_bg.jpg') }}">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="section-title title-style-three text-center mb-70">
                        <span class="sub-title">our pricing plans</span>
                        <h2 class="title">Our Pricing List</h2>
                    </div>
                </div>
            </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-4 col-md-6 col-sm-8">
                        <div class="pricing-box-item mb-30">
                            ...
                            <div class="pricing-list">
                                <ul>
                                    <li class="quality"><i class="fas fa-check"></i> Video quality <span>Good</span>
                                    </li>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-8">
                        <div class="pricing-box-item active mb-30">
                            ...
                            <div class="pricing-list">
                                <ul>
                                    <li class="quality"><i class="fas fa-check"></i> Video quality <span>Better</span>
                                    </li>
